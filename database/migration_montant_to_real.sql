-- Migration: Conversion de la colonne montant de DECIMAL(12,2) vers REAL
-- Date: 15 octobre 2025
-- Description: Change le type de données de la colonne montant pour utiliser REAL au lieu de DECIMAL
...
ALTER TABLE operations 
    ALTER COLUMN montant TYPE REAL;
